...
async function getDados() {
  try {
    const resposta = await fetch("https://viacep.com.br/ws/85990000/json/");
    const dados = await resposta.json();
    console.log(dados);
    document.getElementById("resposta").innerHTML = 
      "O CEP está localizado na região " + dados.regiao;
  } catch (error) {
    console.error("erro:", error);
    document.getElementById("resposta").innerHTML = "Erro ao buscar o CEP.";
  }
}
getDados();
